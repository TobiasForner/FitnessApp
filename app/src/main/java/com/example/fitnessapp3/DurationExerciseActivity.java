    ...
    public void startDuration(View view) {
        ...
        new CountDownTimer(duration * 1000, 1000) {
            ...
            public void onFinish() {
                ...
                if (CurrentWorkout.hasNextExercise() && CurrentWorkout.getNextWorkoutComponent().isExercise() && ((Exercise) CurrentWorkout.getNextWorkoutComponent()).getType() == Exercise.EXTYPE.DURATION) {
                    restartActivity();
                } else {
                    goToNextActivity();
                }
